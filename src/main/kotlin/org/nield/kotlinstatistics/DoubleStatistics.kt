...
// Bin Operators
inline fun <T,R> Iterable<T>.doubleBinBy(bucketSize: Double,
                                         scaleIncrement: Double,
                                         crossinline doubleMapper: (T) -> Double,
                                         crossinline groupOp: (List<Double>) -> R,
                                         rangeStart: Double? = null): BinModel<R, Double> {
...
inline fun <T> Sequence<T>.descriptiveStatisticsBinBy(bucketSize: Double,
                                    scaleIncrement: Double,
                                    crossinline doubleMapper: (T) -> Double,
                                    rangeStart: Double? = null) = toList().descriptiveStatisticsBinBy(bucketSize,scaleIncrement,doubleMapper, rangeStart)

inline fun <T> Iterable<T>.descriptiveStatisticsBinBy(bucketSize: Double,
                                    scaleIncrement: Double,
                                    crossinline doubleMapper: (T) -> Double,
                                    rangeStart: Double? = null) = doubleBinBy(
...
inline fun <T> Sequence<T>.sumBinBy(bucketSize: Double,
                                        scaleIncrement: Double,
                                        crossinline doubleMapper: (T) -> Double,
                                        rangeStart: Double? = null) = toList().sumBinBy(bucketSize,scaleIncrement,doubleMapper, rangeStart)

inline fun <T> Iterable<T>.sumBinBy(bucketSize: Double,
                                    scaleIncrement: Double,
                                    crossinline doubleMapper: (T) -> Double,
                                    rangeStart: Double? = null) = doubleBinBy(
        bucketSize = bucketSize,
...
inline fun <T> Sequence<T>.averageBinBy(bucketSize: Double,
                                        scaleIncrement: Double,
                                        crossinline doubleMapper: (T) -> Double,
                                        rangeStart: Double? = null) = toList().averageBinBy(bucketSize,scaleIncrement,doubleMapper, rangeStart)

inline fun <T> Iterable<T>.averageBinBy(bucketSize: Double,
                                    scaleIncrement: Double,
                                    crossinline doubleMapper: (T) -> Double,
                                    rangeStart: Double? = null) = doubleBinBy(
        bucketSize = bucketSize,
...
inline fun <T> Sequence<T>.minBinBy(bucketSize: Double,
                                        scaleIncrement: Double,
                                        crossinline doubleMapper: (T) -> Double,
                                        rangeStart: Double? = null) = toList().minBinBy(bucketSize,scaleIncrement,doubleMapper, rangeStart)

inline fun <T> Iterable<T>.minBinBy(bucketSize: Double,
                                        scaleIncrement: Double,
                                        crossinline doubleMapper: (T) -> Double,
                                        rangeStart: Double? = null) = doubleBinBy(
        bucketSize = bucketSize,
...
inline fun <T> Sequence<T>.maxBinBy(bucketSize: Double,
                                    scaleIncrement: Double,
                                    crossinline doubleMapper: (T) -> Double,
                                    rangeStart: Double? = null) = toList().maxBinBy(bucketSize,scaleIncrement,doubleMapper, rangeStart)

inline fun <T> Iterable<T>.maxBinBy(bucketSize: Double,
                                    scaleIncrement: Double,
                                    crossinline doubleMapper: (T) -> Double,
                                    rangeStart: Double? = null) = doubleBinBy(
        bucketSize = bucketSize,
...
inline fun <T> Sequence<T>.medianBinBy(bucketSize: Double,
                                    scaleIncrement: Double,
                                    crossinline doubleMapper: (T) -> Double,
                                    rangeStart: Double? = null) = toList().medianBinBy(bucketSize,scaleIncrement,doubleMapper, rangeStart)

inline fun <T> Iterable<T>.medianBinBy(bucketSize: Double,
                                    scaleIncrement: Double,
                                    crossinline doubleMapper: (T) -> Double,
                                    rangeStart: Double? = null) = doubleBinBy(
        bucketSize = bucketSize,
...
inline fun <T> Sequence<T>.percentileBinBy(percentile: Double,
                                       ...
                                       scaleIncrement: Double,
                                       crossinline doubleMapper: (T) -> Double,
                                       rangeStart: Double? = null) = toList().percentileBinBy(bucketSize,percentile,scaleIncrement,doubleMapper, rangeStart)
...
inline fun <T> Sequence<T>.varianceBinBy(bucketSize: Double,
                                    scaleIncrement: Double,
                                    crossinline doubleMapper: (T) -> Double,
                                    rangeStart: Double? = null) = toList().varianceBinBy(bucketSize,scaleIncrement,doubleMapper, rangeStart)

inline fun <T> Iterable<T>.varianceBinBy(bucketSize: Double,
                                    scaleIncrement: Double,
                                    crossinline doubleMapper: (T) -> Double,
                                    rangeStart: Double? = null) = doubleBinBy(
        bucketSize = bucketSize,
...
inline fun <T> Sequence<T>.standardDeviationBinBy(bucketSize: Double,
                                    scaleIncrement: Double,
                                    crossinline doubleMapper: (T) -> Double,
                                    rangeStart: Double? = null) = toList().standardDeviationBinBy(bucketSize,scaleIncrement,doubleMapper, rangeStart)

inline fun <T> Iterable<T>.standardDeviationBinBy(bucketSize: Double,
                                    scaleIncrement: Double,
                                    crossinline doubleMapper: (T) -> Double,
                                    rangeStart: Double? = null) = doubleBinBy(
        bucketSize = bucketSize,
...
inline fun <T> Sequence<T>.geometricMeanBinBy(bucketSize: Double,
                                                  scaleIncrement: Double,
                                                  crossinline doubleMapper: (T) -> Double,
                                                  rangeStart: Double? = null) = toList().geometricMeanBinBy(bucketSize,scaleIncrement,doubleMapper, rangeStart)

inline fun <T> Iterable<T>.geometricMeanBinBy(bucketSize: Double,
                                                  scaleIncrement: Double,
                                                  crossinline doubleMapper: (T) -> Double,
                                                  rangeStart: Double? = null) = doubleBinBy(
        bucketSize = bucketSize,
