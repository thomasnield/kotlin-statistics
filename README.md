...
**NOTE:** This library is being refactored as a DSL around [Apache Commons Math](http://commons.apache.org/proper/commons-math/userguide/stat.html). This developmetn is happening on the `apache-commons-math-refactor` branch. Please feel free to contribute. 
